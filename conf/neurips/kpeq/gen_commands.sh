...
mkdir ilploss
mkdir ../../../logs/neurips/kpeq
mkdir ../../../logs/neurips/kpeq/ilploss
	...
	do
		...
		do
            ...
            do
                ...
                echo "python trainer.py --config conf/neurips/kpeq/ilploss/seed-${seed}/clip-${clip}/cool-${cool}/reset-${reset}/kp4.yaml > logs/neurips/kpeq/ilploss/seed-${seed}_clip-${clip}_cool-${cool}_reset-${reset}_kp4.log 2>&1" >> all_commands.sh 
