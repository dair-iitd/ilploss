...
param_groups_parser = getattr(hpc_utils, config['param_groups'].get('fn_name','param_groups_default_read_out'))
additional_short_names, additional_names, additional_create_dirs, additional_job_list = param_groups_parser(config['param_groups'])
